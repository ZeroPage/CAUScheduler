...
public class Homework extends AbstractHomework {
    ...
    public Homework(String name, String startTime, String endTime, String extendEndTime, boolean isSubmitted, String currentProgressStatus, int submitStudentNum, int totalStudentNum, int orderingNum, boolean isOpenTask) {
