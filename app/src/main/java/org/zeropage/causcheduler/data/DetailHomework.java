...
public class DetailHomework extends AbstractHomework {
    ...
    public DetailHomework(String name, String startTime, String endTime, String extendEndTime, boolean isSubmitted, String currentProgressStatus, int submitStudentNum, int totalStudentNum, int orderingNum) {
